...
public final class DataUtil {
	...
	/**
	 *  员工工号：001019   6位数字    0开头
		起始号段为001001
		
		商家编号：109982   6位数字   1开头
		起始号段为100001
		
		店员编号：207920   6位数字   2开头
		起始号段为200001
	 * @param template
	 * @param data
	 * @return
	 */
	public static String addZeroByString(String type, String data)
	{
	...
	public static void main(String[] args) {
		System.out.print("---"+addZeroByString("1","23"));
	}
}