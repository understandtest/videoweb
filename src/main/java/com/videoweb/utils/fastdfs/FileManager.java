...
public class FileManager implements Config {
    ...
    public void upload(final FileModel file) {
        ...
        if (uploadResults == null) {
            ...
            //remote.file.uri.prefix
            String fileAbsolutePath = PropertiesUtil.getString("remote.file.uri.prefix") + groupName + SEPARATOR
                    + remoteFileName;
            /*String fileAbsolutePath = "http://192.168.199.114:8888/" + groupName + SEPARATOR
                    + remoteFileName;*/
            //相对路径
            String fileRelativePath = groupName + SEPARATOR + remoteFileName;
            file.setRemotePath(fileAbsolutePath);
            file.setReturnPath(fileRelativePath);
