package com.videoweb.utils.word;
...
import com.videoweb.utils.DataUtil;
...
public class WordFilter {
    ...
    {
	    List<String> readWordFromFile = readWordFromFile("wd.txt");
	    String s = "asd你是逗比吗？aｆｕｃｋ！fUcK,你竟然用法轮功，法@!轮!%%%功,hhh满洲第三帝国";
