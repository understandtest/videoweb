...
public class ClientGlobal {
    ...
    public static void init() throws FileNotFoundException, IOException, MyException {
        ...
        g_connect_timeout = PropertiesUtil.getInt("fastDFS.connect_timeout");
        ...
        g_charset = PropertiesUtil.getString("fastDFS.charset");
        ...
        if (szTrackerServers == null) {
            throw new MyException("item \"fastDFS.tracker_server\" in system.properties not found");
        }
        ...
        g_tracker_http_port = PropertiesUtil.getInt("fastDFS.http.tracker_http_port");
        g_anti_steal_token = PropertiesUtil.getBoolean("fastDFS.http.anti_steal_token", false);
        if (g_anti_steal_token) {
            g_secret_key = PropertiesUtil.getString("fastDFS.http.secret_key");
        }
    }
